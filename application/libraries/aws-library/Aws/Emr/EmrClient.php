 ...
 *
 * @method Model addInstanceGroups(array $args = array()) {
 * @command Emr AddInstanceGroups
 * }
 * @method Model addJobFlowSteps(array $args = array()) {
 * @command Emr AddJobFlowSteps
 * }
 * @method Model addTags(array $args = array()) {
 * @command Emr AddTags
 * }
 * @method Model describeCluster(array $args = array()) {
 * @command Emr DescribeCluster
 * }
 * @method Model describeJobFlows(array $args = array()) {
 * @command Emr DescribeJobFlows
 * }
 * @method Model describeStep(array $args = array()) {
 * @command Emr DescribeStep
 * }
 * @method Model listBootstrapActions(array $args = array()) {
 * @command Emr ListBootstrapActions
 * }
 * @method Model listClusters(array $args = array()) {
 * @command Emr ListClusters
 * }
 * @method Model listInstanceGroups(array $args = array()) {
 * @command Emr ListInstanceGroups
 * }
 * @method Model listInstances(array $args = array()) {
 * @command Emr ListInstances
 * }
 * @method Model listSteps(array $args = array()) {
 * @command Emr ListSteps
 * }
 * @method Model modifyInstanceGroups(array $args = array()) {
 * @command Emr ModifyInstanceGroups
 * }
 * @method Model removeTags(array $args = array()) {
 * @command Emr RemoveTags
 * }
 * @method Model runJobFlow(array $args = array()) {
 * @command Emr RunJobFlow
 * }
 * @method Model setTerminationProtection(array $args = array()) {
 * @command Emr SetTerminationProtection
 * }
 * @method Model setVisibleToAllUsers(array $args = array()) {
 * @command Emr SetVisibleToAllUsers
 * }
 * @method Model terminateJobFlows(array $args = array()) {
 * @command Emr TerminateJobFlows
 * }
