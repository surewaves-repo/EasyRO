 ...
 * @command ImportExport CancelJob
 * }
 * @method Model createJob(array $args = array()) {
 * @command ImportExport CreateJob
 * }
 * @method Model getStatus(array $args = array()) {
 * @command ImportExport GetStatus
 * }
 * @method Model listJobs(array $args = array()) {
 * @command ImportExport ListJobs
 * }
 * @method Model updateJob(array $args = array()) {
 * @command ImportExport UpdateJob
 * }
