 ...
 *
 * @method Model addEventSource(array $args = array()) {
 * @command Lambda AddEventSource
 * }
 * @method Model deleteFunction(array $args = array()) {
 * @command Lambda DeleteFunction
 * }
 * @method Model getEventSource(array $args = array()) {
 * @command Lambda GetEventSource
 * }
 * @method Model getFunction(array $args = array()) {
 * @command Lambda GetFunction
 * }
 * @method Model getFunctionConfiguration(array $args = array()) {
 * @command Lambda GetFunctionConfiguration
 * }
 * @method Model invokeAsync(array $args = array()) {
 * @command Lambda InvokeAsync
 * }
 * @method Model listEventSources(array $args = array()) {
 * @command Lambda ListEventSources
 * }
 * @method Model listFunctions(array $args = array()) {
 * @command Lambda ListFunctions
 * }
 * @method Model removeEventSource(array $args = array()) {
 * @command Lambda RemoveEventSource
 * }
 * @method Model updateFunctionConfiguration(array $args = array()) {
 * @command Lambda UpdateFunctionConfiguration
 * }
 * @method Model uploadFunction(array $args = array()) {
 * @command Lambda UploadFunction
 * }
