 ...
 *
 * @method Model search(array $args = array()) {
 * @command CloudSearchDomain Search
 * }
 * @method Model suggest(array $args = array()) {
 * @command CloudSearchDomain Suggest
 * }
 * @method Model uploadDocuments(array $args = array()) {
 * @command CloudSearchDomain UploadDocuments
 * }
 *
