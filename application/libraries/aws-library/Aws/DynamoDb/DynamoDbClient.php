 ...
 *
 * @method Model batchGetItem(array $args = array()) {
 * @command DynamoDb BatchGetItem
 * }
 * @method Model batchWriteItem(array $args = array()) {
 * @command DynamoDb BatchWriteItem
 * }
 * @method Model createTable(array $args = array()) {
 * @command DynamoDb CreateTable
 * }
 * @method Model deleteItem(array $args = array()) {
 * @command DynamoDb DeleteItem
 * }
 * @method Model deleteTable(array $args = array()) {
 * @command DynamoDb DeleteTable
 * }
 * @method Model describeTable(array $args = array()) {
 * @command DynamoDb DescribeTable
 * }
 * @method Model getItem(array $args = array()) {
 * @command DynamoDb GetItem
 * }
 * @method Model listTables(array $args = array()) {
 * @command DynamoDb ListTables
 * }
 * @method Model putItem(array $args = array()) {
 * @command DynamoDb PutItem
 * }
 * @method Model query(array $args = array()) {
 * @command DynamoDb Query
 * }
 * @method Model scan(array $args = array()) {
 * @command DynamoDb Scan
 * }
 * @method Model updateItem(array $args = array()) {
 * @command DynamoDb UpdateItem
 * }
 * @method Model updateTable(array $args = array()) {
 * @command DynamoDb UpdateTable
 * }
