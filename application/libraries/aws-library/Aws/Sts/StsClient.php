 ...
 * }
 * @method Model assumeRoleWithSAML(array $args = array()) {
 * @command Sts AssumeRoleWithSAML
 * }
 * @method Model assumeRoleWithWebIdentity(array $args = array()) {
 * @command Sts AssumeRoleWithWebIdentity
 * }
 * @method Model decodeAuthorizationMessage(array $args = array()) {
 * @command Sts DecodeAuthorizationMessage
 * }
