...
<head>
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            console.log('loading');
            $("#txt_cancel_date_content").datepicker({
                //defaultDate: "+1w",
                dateFormat: "yy-mm-dd",
                changeMonth: true,
        ...
        function getMarketsForContent() {
            var content = $('#content').val();
            var internal_ro = $('#hid_internal_ro').val();
            var cancelDate = $('#txt_cancel_date_content').val();
            $.ajax({
                type: 'POST',
   ...
   <!-- .block_content ends -->
    ...
    <div class="block_content" style="height: auto">
        <form id='cancel_market_content_form'>
            <p><label>Select Content:</label>
                <select class="styled" id="content" name="caption_brand">
                    <option value="">--</option>
            ...
            <p>
                ...
                <input type='text' id='txt_cancel_date_content' class='text date_picker' readonly='readonly'
                       name='txt_cancel_date' style='width:250px;'
                       onchange="javascript:getMarketsForContent()"/>
