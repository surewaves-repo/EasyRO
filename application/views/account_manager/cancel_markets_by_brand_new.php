...
<head>
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $("#txt_cancel_date_brand").datepicker({
                //defaultDate: "+1w",
                dateFormat: "yy-mm-dd",
                changeMonth: true,
        ...
        function getMarketsForBrand() {
            var brand = $('#content').val();
            var internal_ro = $('#hid_internal_ro').val();
            var cancelDate = $('#txt_cancel_date_brand').val();
            $.ajax({
                type: 'POST',
        ...
        function clearData() {
            $('#txt_cancel_date_brand').val("");
            $('#filtered_markets').html("");
        }
...
<div class="block_content" style="height: auto">
    <form id='cancel_market_brand_form'  >
        <p>
            <label>Select Brand:</label>
            <select id="content" name="caption_brand" onchange="javascript:clearData()">
                <option value="">--</option>
        ...
        <p>
            ...
            <input type='text' id='txt_cancel_date_brand' class='text date_picker' readonly='readonly'
                   name='txt_cancel_date' style='width:250px;' onchange="javascript:getMarketsForBrand()"/>
