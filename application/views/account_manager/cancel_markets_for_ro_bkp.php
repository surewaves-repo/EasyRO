                ...
                <form action="<?php echo ROOT_FOLDER ?>/account_manager/post_cancel_markets" method="post"
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <?php foreach ($markets as $mkt) {
                            if (!in_array($mkt['market'], $cancelled_markets)) { ?>
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox"
                                               id="cancel_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                               value="<?php echo $mkt['market'] ?>"
                                               onclick="javascript:price_handler('<?php echo str_replace(" ", "_", $mkt['market']) ?>');show_hide_req_button()"
                                            <?php if (in_array($mkt['market'], $cancel_requested_markets)) {
                                                echo 'disabled="disabled"';
                                            } else if (in_array($mkt['market'], $cancelled_markets)) {
                                                echo 'class="markets_cancelled"';
                                            } else {
                                                echo 'class="markets_to_cancel"';
                                            } ?> >
                                    </td>
                                    <td><?php echo $mkt['market'] ?></td>
                                    <td>
                                        <input type="text"
                                               name="markets[<?php echo str_replace(" ", "_", $mkt['market']) ?>][spot]"
                                               readonly class="amount"
                                               id="spot_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                            <?php if (in_array($mkt['market'], $cancel_requested_markets)) {
                                                echo 'disabled="disabled"';
                                            } ?>
                                    ...
                                    <td>
                                        <input type="text"
                                               name="markets[<?php echo str_replace(" ", "_", $mkt['market']) ?>][banner]"
                                               readonly class="amount"
                                               id="banner_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                            <?php if (in_array($mkt['market'], $cancel_requested_markets)) {
                                                echo 'disabled="disabled"';
                                            } ?>
                                ...
                                <?php ?>
                                <input type="hidden"
                                       name="markets[<?php echo str_replace(" ", "_", $mkt['market']) ?>][spot_fct]"
                                       id="spot_fct_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['spot_fct'] ?>">
                                <input type="hidden"
                                       name="markets[<?php echo str_replace(" ", "_", $mkt['market']) ?>][banner_fct]"
                                       id="banner_fct_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['banner_fct'] ?>">

                                <input type="hidden"
                                       id="hid_spot_fct_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['spot_fct'] ?>">
                                <input type="hidden"
                                       id="hid_banner_fct_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['banner_fct'] ?>">

                                <input type="hidden"
                                       id="hid_spot_fct_cancel_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['spot_fct_after_cancel'] ?>">
                                <input type="hidden"
                                       id="hid_banner_fct_cancel_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['banner_fct_after_cancel'] ?>">

                                <input type="hidden"
                                       id="hid_spot_price_cancel_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['spot_price_after_cancel'] ?>">
                                <input type="hidden"
                                       id="hid_banner_price_cancel_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['banner_price_after_cancel'] ?>">

                                <input type="hidden" id="hid_spot_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['spot_price'] ?>">
                                <input type="hidden" id="hid_banner_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['banner_price'] ?>">

                                <input type="hidden"
                                       name="markets[<?php echo str_replace(" ", "_", $mkt['market']) ?>][is_cancelled]"
                                       id="is_cancelled_<?php echo str_replace(" ", "_", $mkt['market']) ?>" value="0">
                                <input type="hidden"
                                       name="markets[<?php echo str_replace(" ", "_", $mkt['market']) ?>][has_campaigns]"
                                       id="has_campaigns_<?php echo str_replace(" ", "_", $mkt['market']) ?>"
                                       value="<?php echo $mkt['has_campaigns'] ?>">
                            <?php }
                        } ?>
                        ...
                        <tr id="req_controls" style="display: none">
                            <td>&nbsp;</td>
                            <td>
                                <input type="submit" class="submitlong" id="req_market_can" value="Approval Request"
