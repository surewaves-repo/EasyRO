        ...
        <div class="block">
            ...
            <div class="div_cnt">
                ...
                <div class="block_head">
                    ...
                    <form action="<?php echo ROOT_FOLDER ?>/invoice_manager/download_invoice/" method="post" enctype="multipart/form-data" style="float: right;">
                        <div align="right">
                            <label for="month">Month:</label>
                            <input type="text" readonly="readonly" id="month" name="month" value="<?php echo $month?>"/>
                            &nbsp;&nbsp;

                            <input type="submit" class="submit mid" id="" value="Get Invoices" onclick="return check_form()">
                        </div>
                    </form>
                                    ...
                                    <td style="width: 10%">
                                        <?php
                                            ...
                                            if($split[0] == 0){
                                                ...
                                                if($split[1] == 1){
                                                    $str = 'Split by Market and Brand';
                                                }else if($split[2] == 1){
                                                    $str = 'Split by Market and Content';
                                                }else{
                                                    $str = 'Split by Market';
                                                }
