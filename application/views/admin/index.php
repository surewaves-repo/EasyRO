	...
	<div id="hld">
		...
		<div class="block small center login">
				...
				<div class="block_head">
					...
					<h2>SureWaves Easy RO Admin Login</h2>
					<img src="<?php echo ROOT_FOLDER ?>/images/EasyR0-logo-Black.PNG" width="130" height="35px"style="float:right; padding-top:13px;" />
				...
				<div class="block_content">
					...
					<form action="<?php echo ROOT_FOLDER ?>/admin/post_login" method="post" >
						<p>
