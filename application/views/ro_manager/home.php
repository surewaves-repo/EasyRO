			...
			<div id="header">
				...
				<ul id="nav">
					<li class="active" ><a href="<?php echo ROOT_FOLDER ?>/account_manager/home">Home</a>
                    	<!--<ul id="nav">
							<li class="active" ><a href="<?php echo ROOT_FOLDER ?>/account_manager/home">New Home</a></li>
                            </ul> -->
					...
					<li><a href="<?php echo ROOT_FOLDER ?>/ro_manager/network_ro_report">Reports</a>
						<ul id="nav">
							...
							<li ><a href="<?php echo ROOT_FOLDER ?>/ro_manager/update_network_payment">Update N/w Payment</a></li>
							<?php } ?>
						</ul>
					</li>
				...
				<div class="block_content">				
						...
						<table cellpadding="0" cellspacing="0" width="100%">
							...
							<?php foreach ( $ro_list as $content) { ?>
								<tr>
									<!--<td> <?php echo $content['internal_ro_number']?><br/> <?php if(isset($content['client_name'])) {echo '(Client:'.$content['client_name']." ,Brand:".$content['brand_new']." ,Product:".$content['product_new']." )" ;} ?> </td>-->
									...
									<td><a href="javascript:approve('<?php echo  rtrim(base64_encode($content['internal_ro_number']),'=') ?>','<?php echo $content['ro_approval_status'] ?>','<?php echo $content['id']?>')"><img src="<?php echo ROOT_FOLDER ?>/images/add-one.png" /></a></td>
